"""Boot-only proof: launch Isaac Sim via the RoboLens adapter on the real install.

Run with the venv that has isaacsim/isaaclab, and RoboLens + this package on the
...
from robolens import Embodiment
...
def main() -> int:
    ...
    # Sanity: the adapter is a valid RoboLens Embodiment and its info is readable
